...
export function Header({ header }: { header: HeaderType }) {
  ...
  const NavMenu = () => {
    const navItemClass =
      '!h-10 !w-max !rounded-xl !border-0 !bg-transparent px-4 py-1.5 text-sm !font-medium !text-inherit !shadow-none transition-all duration-200 xl:px-5';

    return (
      <NavigationMenu
        viewport={false}
        className="flex-1 justify-center **:data-[slot=navigation-menu-content]:top-10 max-lg:hidden"
      >
              ...
              return (
                <NavigationMenuLink key={idx} asChild>
                  <Link
                    ...
                    className={cn(
                      navItemClass,
                      'hover:!bg-muted focus:!bg-muted flex flex-row items-center gap-2',
            ...
            return (
              <NavigationMenuItem key={idx}>
                <NavigationMenuTrigger
                  className={cn(
                    navItemClass,
                    'hover:!bg-muted focus:!bg-muted data-[state=open]:!bg-muted/60 flex flex-row items-center gap-2'
                  )}
                >
                  {item.icon && (
        ...
        >
          <div className="container">
            <div className="relative flex flex-wrap items-center justify-between lg:py-5">
              <div className="flex justify-between gap-8 max-lg:h-14 max-lg:w-full max-lg:border-b lg:hidden">
              ...
              <nav
                ...
                className="hidden w-full items-center justify-between gap-4 lg:flex"
              >
              ...
              <div className="mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 in-data-[state=active]:flex max-lg:in-data-[state=active]:mt-6 md:flex-nowrap lg:hidden">
