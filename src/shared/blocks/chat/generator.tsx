...
export function ChatGenerator() {
  ...
  const fetchNewChat = async (
    ...
    try {
      ...
      const message =
        e instanceof Error ? e.message : t('request_failed');
      setStatus('error');
      setError(message);
      toast.error(message);
  ...
  return (
    <div className="flex min-h-dvh flex-col overflow-hidden">
      ...
      <div className="mx-auto flex min-h-0 w-full flex-1 flex-col items-center justify-center px-4 py-6 md:max-w-2xl">
