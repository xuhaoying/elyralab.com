...
export const AppContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [userCreditsError, setUserCreditsError] = useState<string | null>(null);
  ...
  const fetchUserCredits = useCallback(async () => {
    try {
      ...
      setUserCreditsError(
        e instanceof Error ? e.message : 'fetch user credits failed'
      );
      if (process.env.NODE_ENV !== 'production') {
